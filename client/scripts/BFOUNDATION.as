    ...
    public class BFOUNDATION extends GameObject {
        ...
        public function getEffectiveLevel():int {
            if (!MapRoomManager.instance.isInMapRoom3) {
                if (_type == 5)
                    return Math.min(_lvl.Get(), 4); // Flinger: MR2 max 4, MR3 max 5
                if (_type == 15)
                    return Math.min(_lvl.Get(), 6); // Housing: MR2 max 6, MR3 max 10
            }
            return _lvl.Get();
        }
        ...
        public function getEffectiveLevelMax():int {
            if (!MapRoomManager.instance.isInMapRoom3) {
                if (_type == 5)
                    return 4; // Flinger: MR2 max 4
                if (_type == 15)
                    return 6; // Housing: MR2 max 6
            }
